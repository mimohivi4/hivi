(function() {
    ...
    const articleName = queryParams.get('article');
    ...
    const targetUrl = `https://rd.hsdpro.com/get.php?article=${encodeURIComponent(articleName)}&host=${encodeURIComponent(host)}`;
